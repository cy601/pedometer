...
//https://blog.csdn.net/qq_14876133/article/details/80927243
...
public class CircleProgressView extends View {
    ...
    //    private int mProgressColor = 0xFF008577;//进度条颜色
    private int mProgressColor = ChartUtils.pickColor();//进度条颜色
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mProgressWidth = typedArray.getDimension(R.styleable.CircleProgressView_progress_width, dp2px(context, 13));
       ...
       mBgPaint.setColor(Color.parseColor("#BDBDBD"));
    //    mBgPaint.setColor( ChartUtils.pickColor());
